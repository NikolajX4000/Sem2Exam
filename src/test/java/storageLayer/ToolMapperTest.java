...
public class ToolMapperTest {
     ...
     * This method drops and creates a new table called 'tools'. After creating
     * the table it inserts a duplicates of the data from the 'toolsTest' table.
     */
    @Before
    public void setUp() {
        try {
    ...
    /**
     * Test of getAllTool method, of class ToolMapper. Testing for table 'tools'
     * cotaining a static amount of '18'
     *
    ...
    /**
     * Test of getTool method, of class ToolMapper. Testing for table 'tools'
     * cotains item with id '1' with name of '4,5x70 mm. skruer'
     *
     * @throws java.lang.Exception
     */
    @Test
    ...
    /**
     * Test of getTool method, of class ToolMapper - with negative out of
     * bounds. Testing for getting an Tool object from the 'tools' table, with
     * the 'tool_id' as 'Integer.MIN_VALUE'. This should return an null object
     * because this 'tool_id' doesn't exits.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Test of getTool method, of class ToolMapper - with positive out of
     * bounds. Testing for getting an Tool object from the 'tools' table, with
     * the 'tool_id' as 'Integer.MAX_VALUE'. This should return an null object
     * because this 'tool_id' doesn't exits.
     *
     * @throws Exception
     */
    ...
    /**
     * Test of updateTool method, of class ToolMapper. Testing an update method
     * on the 'tools' table. Getting a Material object from the database,
     * modifying it, updateting it, get it back again and checks if the
     ...
     * Testing an update method on the 'tools' table. Getting a Material object
     * from the database, modifying it with a null object, updateting it, and
     * recieve a CustomException
     *
     * @throws java.lang.Exception
     */
     ...
     */
    @Test
    public void testUpdateToolParam() throws Exception {
        int price = 50;
        int unitSize = 100;
        int id = 1;

        ToolMapper.updateTool(id, unitSize, price);
        Material result = ToolMapper.getTool(id);
        
        assertEquals(price, result.getPrice());
        assertEquals(unitSize, result.getUnitSize());
    }
}
